...
class DaggerMavericksViewModelFactory<VM : MavericksViewModel<S>, S : MavericksState>(
    ...
    private fun <VM : MavericksViewModel<S>, S : MavericksState> createViewModel(state: S): VM {
        val viewModelFactoryMap = DIApplicationManager.applicationComponent.viewModelFactories()
